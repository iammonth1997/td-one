 ...
 * Centralized RBAC enforcement for server API routes
...
async function logPermissionDenial(
  ...
  try {
    ...
    console.error("[RBAC DENIAL] Failed to log permission denial:", error);
  }
}
 ...
 *
 * @param {Function} handler - API route handler (GET, POST, etc)
