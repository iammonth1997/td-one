...
export const API_ROUTE_MAP = {
  ...
  attendance: {
    ...
    "GET /api/admin/attendance-suspicious": {
      permissions: ["attendance.read.all", "rbac.manage"],
      fallback: ["rbac.manage"],
      description: "Admin: List suspicious attendance scans",
    },
    "PUT /api/admin/attendance-suspicious/[id]": {
      permissions: ["attendance.edit.all", "rbac.manage"],
      fallback: ["rbac.manage"],
      description: "Admin: Approve/reject flagged attendance scan",
    },
  },
