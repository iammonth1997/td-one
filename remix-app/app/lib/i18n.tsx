...
const LITERAL_ENTRIES: TranslationEntry[] = [
  ...
  { th: "สร้างคำขอใหม่", en: "Create request", lo: "ສ້າງຄຳຂໍໃໝ່" },
  ...
  { th: "แดชบอร์ด", en: "Dashboard", lo: "ແດຊບອດ" },
  { th: "พนักงาน", en: "Employees", lo: "ພະນັກງານ" },
  { th: "การเข้างาน", en: "Attendance", lo: "ການເຂົ້າວຽກ" },
  { th: "คำขอ", en: "Requests", lo: "ຄຳຂໍ" },
  { th: "สรรหาพนักงาน", en: "Recruitment", lo: "ສະຫາພະນັກງານ" },
  { th: "HR-ER", en: "HR-ER", lo: "HR-ER" },
