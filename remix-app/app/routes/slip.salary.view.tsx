...
> = {
  th: {
    ...
    description: "กรุณายืนยันรหัสผ่านอีกครั้งก่อนเปิดสลิปเงินเดือนสำหรับพิมพ์",
  ...
  en: {
    ...
    description: "Please confirm your password again before opening the printable salary slip.",
  ...
  lo: {
    ...
    description: "ກະລຸນາຢືນຢັນລະຫັດຜ່ານອີກຄັ້ງກ່ອນເປີດສະລິບເງິນເດືອນສໍາລັບພິມ",
...
export default function SalarySlipViewPage() {
  ...
  } = useSalaryProtectedSlip("/api/salary-slip", year, month, salaryAccessCopy);
